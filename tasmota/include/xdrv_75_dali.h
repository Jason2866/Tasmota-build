...
#define DALI_102_WRITE_MEMORY_LOCATION             0x00C7  // 275 - Write data into the specified address of the specified memory bank. (There is BW) (DTR(DTR0)：address, DTR1：memory bank number)
...
#define DALI_102_WRITE_MEMORY_LOCATION_NO_REPLY    0x00C9  // 276 - DALI-2 Write data into the specified address of the specified memory bank. (There is no BW) (DTR(DTR0)：address, TR1：memory bank number)
                                                           //       This instruction will be ignored if the addressed memory bank is not implemented, or writeEnableState is DISABLED.
...
#define DALI_207_QUERY_LOAD_INDREASE               0x00F5  // 245 - Returns bit3 load increase of‘FAILURE STATUS’
